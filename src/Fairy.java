...
public final class Fairy extends EntityAbstract implements Being {
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        if (fairyTarget.isPresent()) {
            ...
            if (this.moveTo(world, fairyTarget.get(), scheduler)) {
                ...
                Sapling sapling = Creates.createSapling(ImageStore.SAPLING_KEY + "_" + fairyTarget.get().getId(), tgtPos, imageStore.getImageList(ImageStore.SAPLING_KEY), 0);
