...
public final class Princess extends EntityAbstract implements Being {

    private final double animationPeriod;
    private final double actionPeriod;

    public Princess(String id, Point position, List<PImage> images, double actionPeriod, double animationPeriod) {
...
//            Obstacle water = new Obstacle("obstacle", currPos, .getImageList("obstacle"), 1);
//            world.setOccupancyCell(currPos, water);
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        Optional<Entity> frogTarget = findNearest(world, this.getPosition(), new ArrayList<>(List.of(Frog.class)));
